...
public class total_dpm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_total_dpm);

        pd = new ProgressDialog(total_dpm.this);
    ...
    public void load_data_from_server() {
        pd.show();
        String url = "https://bankku.yippytech.com/pemira/votedpm.php";
