...
public class from_voting_dpm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_from_voting_dpm);
    ...
    private void prosesVote() {
        ...
        String url = Constant.BASE_URL + "paslondpm.php?idvote="+id_paslon;
...
//                            editor.commit();
//                        */regis
                        Toast.makeText(from_voting_dpm.this," VOTING SUKSES",Toast.LENGTH_LONG).show();
                        intent = new Intent(from_voting_dpm.this, MenuUtama.class);
                        startActivity(intent);

                    } else {
                        Toast.makeText(from_voting_dpm.this,"VOTING GAGAL",Toast.LENGTH_LONG).show();
                    }
